...
exports.create = (req, res) => {
    ...
    .catch(err => {
        res.status(500).send({
            message: err.message || "Unexpected error ocurred while creating the Tutorial."
        });
    });
};
...
exports.findAll = (req, res) => {
    ...
    Tutorial.findAll({ where: condition})
        ...
        .catch(err => {
            res.status(500).send({
                message: err.message || "Unexpected error ocurred while retrieving tutorials."
            });
        });
};
